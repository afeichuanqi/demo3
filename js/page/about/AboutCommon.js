...
import {View, Text, DeviceInfo, Platform, Image, Dimensions, StyleSheet} from 'react-native';
    ...
    getParallaxRenderConfig(params) {
        ...
        config.renderFixedHeader = () => (
            <View key="fixed-header" style={styles.fixedSection}>
                ...
                {/*Scroll to top*/}
                {/*</Text>*/}
                {ViewUtil.getLeftBackButton(() => NavigationUtils.goBack(this.props.navigation))}
